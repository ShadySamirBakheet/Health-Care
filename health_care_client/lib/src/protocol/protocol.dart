...
import 'patient_class.dart' as _i3;
import 'user_class.dart' as _i4;
import 'package:health_care_client/src/protocol/patient_class.dart' as _i5;
export 'example.dart';
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i1.getType<List<_i5.Patient>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i5.Patient>(e)).toList()
          : null) as dynamic;
    }
