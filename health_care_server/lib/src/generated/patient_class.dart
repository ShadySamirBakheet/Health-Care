  ...
  void setColumn(
    ...
    switch (columnName) {
      ...
      case 'healthyReport':
        healthyReport = value;
        return;
      case 'healthyReportShort':
        healthyReportShort = value;
        return;
      case 'reports':
        reports = value;
        return;
...
class PatientTable extends _i1.Table {
  PatientTable() : super(tableName: 'patinet');
  ...
  final age = _i1.ColumnDouble('age');

  final gender = _i1.ColumnBool('gender');

  final healthyReport = _i1.ColumnString('healthyReport');

  final healthyReportShort = _i1.ColumnString('healthyReportShort');

  final reports = _i1.ColumnSerializable('reports');
