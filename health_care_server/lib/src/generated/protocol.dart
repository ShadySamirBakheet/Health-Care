...
import 'patient_class.dart' as _i4;
import 'user_class.dart' as _i5;
import 'package:health_care_server/src/generated/patient_class.dart' as _i6;
export 'example.dart';
export 'patient_class.dart';
...
class Protocol extends _i1.SerializationManagerServer {
    ...
    _i2.TableDefinition(
      ...
      columns: [
        _i2.ColumnDefinition(
          ...
          isNullable: false,
          dartType: 'int?',
          columnDefault: 'nextval(\'patinet_id_seq\'::regclass)',
        ),
        _i2.ColumnDefinition(
          name: 'name',
  ...
  T deserialize<T>(
    ...
    if (t == _i1.getType<List<_i6.Patient>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i6.Patient>(e)).toList()
          : null) as dynamic;
    }
    try {
